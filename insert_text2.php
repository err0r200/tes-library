...
$x = $data['x'];
$y = $data['y'];
$pageToUpdate = $data['page']; // Halaman yang ingin diperbarui dengan teks
$text = $data['text'];
...
for ($page = 1; $page <= $pageCount; $page++) {
    ...
    // Menambahkan teks pada halaman tertentu
    if ($page === $pageToUpdate) {
        // Mengatur font untuk teks
        $pdf->SetFont('Helvetica', '', 12); // Ukuran font yang lebih besar untuk visibilitas
