...
<script src="https://code.jquery.com/jquery-3.7.1.js" integrity="sha256-eKhayi8LEQwp4NKxN+CfCh+3qOVUtJn3QNZ0TciWLP4=" crossorigin="anonymous"></script>
    ...
    <script>
		...
		function calculateScaleRatio() {
			const pdfWidth = currentPageViewport.width;  // Lebar PDF asli
			const pdfHeight = currentPageViewport.height;  // Tinggi PDF asli

			const canvasWidth = canvas.width;  // Lebar canvas di frontend
			const canvasHeight = canvas.height;  // Tinggi canvas di frontend
		...
		function sendQrBoxDetailsToServer() {
			...
			const { canvasWidth, canvasHeight } = calculateScaleRatio();
			const dataToSend = {
				qrBoxDetails,
				canvasWidth,
				canvasHeight
